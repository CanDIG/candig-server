...
project = 'candig-server'
copyright = '2019, CanDIG Team'
author = 'CanDIG Team'
...
version = "1.2.1"  # candig.server.__version__.split("+")[0]
# The full version, including alpha/beta/rc tags.
release = "1.2.1"  # candig.server.__version__
...
latex_documents = [
  (master_doc, 'CANDIG.tex', 'CanDIG Documentation',
   'CanDIG Team', 'manual'),
]
