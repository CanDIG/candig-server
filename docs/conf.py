...
version = candig.server.__version__.split("+")[0]
# The full version, including alpha/beta/rc tags.
release = candig.server.__version__
...
latex_documents = [
  (master_doc, 'GA4GH.tex', 'GA4GH Documentation',
   'Global Alliance for Genomics and Health', 'manual'),
]
...
man_pages = [
    (master_doc, 'candig', 'GA4GH Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'GA4GH', 'GA4GH Documentation',
   author, 'GA4GH', 'A reference implementation of the candig API.',
   'Miscellaneous'),
]
...
# Mapping for where to find documentation for Python types.
intersphinx_mapping = {'https://docs.python.org/': None}

# If True, show TODOs in the generated documentation.
