...
class Outcome(BaseModel):
    ...
    siteOfRelapseOrProgression = pw.TextField(null=True)
    siteOfRelapseOrProgressionTier = pw.TextField(null=True)
    intervalProgressionOrRecurrence = pw.TextField(null=True)
    intervalProgressionOrRecurrenceTier = pw.TextField(null=True)
    intervalRegressionOrDecreaseInDisease = pw.TextField(null=True)
    intervalRegressionOrDecreaseInDiseaseTier = pw.TextField(null=True)
    levelOfMalignancy = pw.TextField(null=True)
    levelOfMalignancyTier = pw.TextField(null=True)
    treatmentInducedNeoplasmSite = pw.TextField(null=True)
    treatmentInducedNeoplasmSiteTier = pw.TextField(null=True)
    dateOfDiagnosisOfTreatmentInducedNeoplasm = pw.TextField(null=True)
    dateOfDiagnosisOfTreatmentInducedNeoplasmTier = pw.TextField(null=True)
...
class Tumourboard(BaseModel):
    ...
    actionableExpressionOutlier = pw.TextField(null=True)
    actionableExpressionOutlierTier = pw.TextField(null=True)
    actionableGermlineVariant = pw.TextField(null=True)
    actionableGermlineVariantTier = pw.TextField(null=True)
    germlineVariantsDrug = pw.TextField(null=True)
    germlineVariantsDrugTier = pw.TextField(null=True)
    germlineVariantsDrugClass = pw.TextField(null=True)
    germlineVariantsDrugClassTier = pw.TextField(null=True)
    germlineVariantsDiscussed = pw.TextField(null=True)
    germlineVariantsDiscussedTier = pw.TextField(null=True)
    actionableSomaticVariants = pw.TextField(null=True)
    actionableSomaticVariantsTier = pw.TextField(null=True)
    somaticVariantsDrug = pw.TextField(null=True)
    somaticVariantsDrugTier = pw.TextField(null=True)
    somaticVariantsDrugClass = pw.TextField(null=True)
    somaticVariantsDrugClassTier = pw.TextField(null=True)
    somaticVariantsDiscussed = pw.TextField(null=True)
    somaticVariantsDiscussedTier = pw.TextField(null=True)
    anyActionableExpressionOutlier = pw.TextField(null=True)
    anyActionableExpressionOutlierTier = pw.TextField(null=True)
    expressionDrug = pw.TextField(null=True)
    expressionDrugTier = pw.TextField(null=True)
    expressionDrugClass = pw.TextField(null=True)
    expressionDrugClassTier = pw.TextField(null=True)
    expressionTypeOfAnalysisUsed = pw.TextField(null=True)
    expressionTypeOfAnalysisUsedTier = pw.TextField(null=True)
    expressionTypeOfInformationUtility = pw.TextField(null=True)
    expressionTypeOfInformationUtilityTier = pw.TextField(null=True)
    expressionAlteredGene = pw.TextField(null=True)
    expressionAlteredGeneTier = pw.TextField(null=True)
    expressionNonActionableGene = pw.TextField(null=True)
    expressionNonActionableGeneTier = pw.TextField(null=True)
    expressionTypeOfAlteration = pw.TextField(null=True)
    expressionTypeOfAlterationTier = pw.TextField(null=True)
    anyActionableGermlineVariants = pw.TextField(null=True)
    anyActionableGermlineVariantsTier = pw.TextField(null=True)
    germlineVariantsTypeOfAnalysisUsed = pw.TextField(null=True)
    germlineVariantsTypeOfAnalysisUsedTier = pw.TextField(null=True)
    germlineVariantsClassificationOfVariants = pw.TextField(null=True)
    germlineVariantsClassificationOfVariantsTier = pw.TextField(null=True)
    germlineVariantsTypeOfInformationUtility = pw.TextField(null=True)
    germlineVariantsTypeOfInformationUtilityTier = pw.TextField(null=True)
    anyActionableSomaticVariants = pw.TextField(null=True)
    anyActionableSomaticVariantsTier = pw.TextField(null=True)
    somaticVariantsTypeOfAnalysisUsed = pw.TextField(null=True)
    somaticVariantsTypeOfAnalysisUsedTier = pw.TextField(null=True)
    somaticVariantsTypeOfInformationUtility = pw.TextField(null=True)
    somaticVariantsTypeOfInformationUtilityTier = pw.TextField(null=True)
    somaticVariantsNonActionable = pw.TextField(null=True)
    somaticVariantsNonActionableTier = pw.TextField(null=True)
